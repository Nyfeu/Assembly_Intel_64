...
;  **********  Seção - data  ************************************************************************  ;
	...
	section .data
	message: db 'Hello, World!', 10   ;  Mensagem a ser escrita - através da diretiva 'db' (data byte) -
                                          ;  com nova linha ao final. O byte '10' é o caractere especial de 
                                          ;  nova linha na tabela ASCII - '\n' (End of Line).  
                                          ;  A separação por vírgula garante que o caractere especial
                                          ;  será alocado no endereço seguinte ao da cadeia de caracteres,
...
;  **********  Seção - text  ******************************i******************************************  ;
	...
	_start:                           ;  Para nos livrarmos dos endereços numéricos, usamos rótulos.
                                          ;  A instrução 'mov' serve para atribuir um valor ao registrador
