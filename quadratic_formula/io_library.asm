...
;  > Como este código funcionará como uma library, não precisará de um ponto de entrada. No
;    entanto, ainda é necessário tornar as funções acessíveis por meio da diretiva 'global'.
